...
<head>
    <meta charset="utf-8" />
    <title>Jeferson Junio Beijo</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Jeferson Junio Beijo" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Jeferson Junio Beijo" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/foto.png" alt="Jeferson Junio Beijo">
                    </div>
                        ...
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/jeferson-junio-beijo-0b4a975b/" target="blank"
                                    title="Linkedin Jeferson Beijo" ALT="Jeferson Beijo">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/jefersonbeijo" target="blank" title="GitHub Jeferson Beijo"
                                    ALT="GitHub Jeferson Beijo">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/jefersonbeijo" target="blank" title="Twitter Jeferson Beijo"
                                    ALT="Twitter Jeferson Beijo">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            jeferson.beijo@escola.pr.gov.br
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=5543996308928" target="blank"
                                title="Whatsapp Jeferson Beijo" ALT="Whatsapp Jeferson Beijo">+55 (43) 99630-8928</a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <aside class="col-12 col-md-12 col-lg-2">
                    <div class="sidebar box sticky-column">
                        <ul class="nav">
                            ...
                            <li class="nav__item"><a href="projetos.html"><i class="icon-codesandbox"></i>Portifólio</a>
                            </li>
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Jeferson Junio Beijo 2025</footer>
                </div>
            </div>
        </div>
    </main>
